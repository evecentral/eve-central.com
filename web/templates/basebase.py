...
__CHEETAH_genTime__ = 1265364391.2424729
__CHEETAH_genTimestamp__ = 'Fri Feb  5 02:06:31 2010'
__CHEETAH_src__ = 'basebase.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Feb  5 02:06:25 2010'
...
''')
    ...
    def _title(self, **KWS):
        ...
        ## CHEETAH: generated from #block _title at line 56, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write(u'''
''')
        if VFN(VFFSL(SL,"title",True),"find",False)("EVE-Central") != -1: # generated from line 58, col 1
            pass
        else: # generated from line 60, col 1
            write(u''' EVE-Central -
''')
        write(u''' ''')
        _v = VFFSL(SL,"title",True) # u'$title' on line 63, col 2
        if _v is not None: write(_filter(_v, rawExpr=u'$title')) # from line 63, col 2.
        write(u'''
''')
    ...
    def _banner(self, **KWS):
        ...
        ## CHEETAH: generated from #block _banner at line 109, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write(u'''<h1>''')
        _v = VFFSL(SL,"banner",True) # u'$banner' on line 110, col 5
        if _v is not None: write(_filter(_v, rawExpr=u'$banner')) # from line 110, col 5.
        write(u'''</h1>
''')
...
<td class="alignRight">
''')
        if 'user' in VFFSL(SL,"session",True): # generated from line 91, col 1
            write(u'''<a href="/users/"><i>''')
            _v = VFN(VFFSL(SL,"session",True)['user'],"username",True) # u"$session['user'].username" on line 92, col 22
            if _v is not None: write(_filter(_v, rawExpr=u"$session['user'].username")) # from line 92, col 22.
...
''')
        ...
        write(u'''
''')
        if VFFSL(SL,"isigb",True): # generated from line 113, col 1
            write(u'''
''')
        else: # generated from line 115, col 1
            write(u'''    <div id="bodyText">
''')
        _v = VFFSL(SL,"body",True) # u'$body' on line 118, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$body')) # from line 118, col 1.
        write(u'''
...
<!-- All times GMT unless otherwise specified. It is now: <b>''')
        _v = VFN(VFFSL(SL,"timefoot",True),"Format",False)("%b %e %H:%M") # u'$timefoot.Format("%b %e %H:%M")' on line 130, col 62
        if _v is not None: write(_filter(_v, rawExpr=u'$timefoot.Format("%b %e %H:%M")')) # from line 130, col 62.
        write(u''' (GMT)</b> -->
