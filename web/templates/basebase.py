...
__CHEETAH_genTime__ = 1248808699.9256711
__CHEETAH_genTimestamp__ = 'Tue Jul 28 12:18:19 2009'
__CHEETAH_src__ = 'basebase.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Jul 28 12:18:04 2009'
...
''')
    ...
    def _title(self, **KWS):
        ...
        ## CHEETAH: generated from #block _title at line 65, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write('''
''')
        if VFN(VFFSL(SL,"title",True),"find",False)("EVE-Central") != -1: # generated from line 67, col 1
            pass
        else: # generated from line 69, col 1
            write(''' EVE-Central -
''')
        write(''' ''')
        _v = VFFSL(SL,"title",True) # '$title' on line 72, col 2
        if _v is not None: write(_filter(_v, rawExpr='$title')) # from line 72, col 2.
        write('''
''')
    ...
    def _banner(self, **KWS):
        ...
        ## CHEETAH: generated from #block _banner at line 142, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write('''<h1>''')
        _v = VFFSL(SL,"banner",True) # '$banner' on line 143, col 5
        if _v is not None: write(_filter(_v, rawExpr='$banner')) # from line 143, col 5.
        write('''</h1>
''')
...
''')
        if VFFSL(SL,"isigb",True): # generated from line 56, col 1
            write('''
''')
...
''')
        if VFFSL(SL,"isigb",True): # generated from line 81, col 1
...
<br />
''')
            if 'user' in VFFSL(SL,"session",True): # generated from line 84, col 1
                write('''<a href="/users/"><i>''')
                _v = VFN(VFFSL(SL,"session",True)['user'],"username",True) # "$session['user'].username" on line 85, col 22
                if _v is not None: write(_filter(_v, rawExpr="$session['user'].username")) # from line 85, col 22.
                write('''</i></a> <a href="/users/logout.html">Logout</a>
''')
            else: # generated from line 86, col 1
...
<td class="alignRight">
''')
            if 'user' in VFFSL(SL,"session",True): # generated from line 124, col 1
                write('''<a href="/users/"><i>''')
                _v = VFN(VFFSL(SL,"session",True)['user'],"username",True) # "$session['user'].username" on line 125, col 22
                if _v is not None: write(_filter(_v, rawExpr="$session['user'].username")) # from line 125, col 22.
                write('''</i></a> <a href="/users/logout.html">Logout</a>
''')
            else: # generated from line 126, col 1
                write('''<a href="/users/">Register and Login</a>
&nbsp;
''')
            write('''|
''')
            ...
            write('''
''')
            _v = VFN(VFFSL(SL,"timehead",True),"Format",False)("%b %e %H:%M") # '$timehead.Format("%b %e %H:%M")' on line 133, col 1
            if _v is not None: write(_filter(_v, rawExpr='$timehead.Format("%b %e %H:%M")')) # from line 133, col 1.
            write('''
</td>
</tr>
</table>
...
''')
        ...
        write('''
''')
        if VFFSL(SL,"isigb",True): # generated from line 146, col 1
            write('''
''')
        else: # generated from line 148, col 1
            write('''\t<div id="bodyText">
''')
        _v = VFFSL(SL,"body",True) # '$body' on line 151, col 1
        if _v is not None: write(_filter(_v, rawExpr='$body')) # from line 151, col 1.
        write('''


''')
        if VFFSL(SL,"isigb",True): # generated from line 154, col 1
            write('''<p>
...
''')
        else: # generated from line 158, col 1
            write('''
\t</div>
''')
        write('''
...
<!-- All times GMT unless otherwise specified. It is now: <b>''')
        _v = VFN(VFFSL(SL,"timefoot",True),"Format",False)("%b %e %H:%M") # '$timefoot.Format("%b %e %H:%M")' on line 169, col 62
        if _v is not None: write(_filter(_v, rawExpr='$timefoot.Format("%b %e %H:%M")')) # from line 169, col 62.
        write(''' (GMT)</b> -->


<p class="adLink">
''')
        if VFFSL(SL,"isigb",True): # generated from line 173, col 1
            write('''
''')
        else: # generated from line 175, col 1
            write('''
