...
__CHEETAH_genTime__ = 1313278744.8860979
__CHEETAH_genTimestamp__ = 'Sat Aug 13 23:39:04 2011'
__CHEETAH_src__ = 'basebase.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Aug 13 23:38:53 2011'
...
<!-- <div class="standout">
IMPORTANT: Updated Contribtastic for Incarna, no item database updates yet!
...
''')
        ...
        write(u'''
''')
        _v = VFN(VFFSL(SL,"timehead",True),"Format",False)("%b %e %H:%M") # u'$timehead.Format("%b %e %H:%M")' on line 103, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$timehead.Format("%b %e %H:%M")')) # from line 103, col 1.
        write(u'''
</td>
</tr>
</table>
...
''')
        ...
        write(u'''
''')
        if VFFSL(SL,"isigb",True): # generated from line 116, col 1
            write(u'''
''')
        else: # generated from line 118, col 1
            write(u'''    <div id="bodyText">
''')
        _v = VFFSL(SL,"body",True) # u'$body' on line 121, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$body')) # from line 121, col 1.
        write(u'''
...
<!-- All times GMT unless otherwise specified. It is now: <b>''')
        _v = VFN(VFFSL(SL,"timefoot",True),"Format",False)("%b %e %H:%M") # u'$timefoot.Format("%b %e %H:%M")' on line 133, col 62
        if _v is not None: write(_filter(_v, rawExpr=u'$timefoot.Format("%b %e %H:%M")')) # from line 133, col 62.
        write(u''' (GMT)</b> -->
