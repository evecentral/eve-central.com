...
__CHEETAH_genTime__ = 1299998794.43661
__CHEETAH_genTimestamp__ = 'Sun Mar 13 06:46:34 2011'
__CHEETAH_src__ = 'basebase.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Mar 13 06:46:20 2011'
...
''')
    ...
    def _banner(self, **KWS):
        ...
        write(u'''<h1>''')
        _v = VFFSL(SL,"banner",True) # u'$banner' on line 109, col 5
        if _v is not None: write(_filter(_v, rawExpr=u'$banner')) # from line 109, col 5.
        write(u'''</h1>
''')
...
<!-- All times GMT unless otherwise specified. It is now: <b>''')
        _v = VFN(VFFSL(SL,"timefoot",True),"Format",False)("%b %e %H:%M") # u'$timefoot.Format("%b %e %H:%M")' on line 129, col 62
        if _v is not None: write(_filter(_v, rawExpr=u'$timefoot.Format("%b %e %H:%M")')) # from line 129, col 62.
        write(u''' (GMT)</b> -->
