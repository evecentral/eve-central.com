...
__CHEETAH_genTime__ = 1417653693.542509
__CHEETAH_genTimestamp__ = 'Thu Dec  4 00:41:33 2014'
__CHEETAH_src__ = 'basebase.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Dec  4 00:39:07 2014'
...
''')
    ...
    def _title(self, **KWS):
        ...
        write(u'''
''')
        if VFN(VFFSL(SL,"title",True),"find",False)("EVE-Central") != -1: # generated from line 73, col 1
            pass
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr=u'$title')) # from line 78, col 2.
        write(u'''
''')
    ...
    def _banner(self, **KWS):
        ...
        ## CHEETAH: generated from #block _banner at line 105, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write(u'''<h1>''')
        _v = VFFSL(SL,"banner",True) # u'$banner' on line 106, col 5
        if _v is not None: write(_filter(_v, rawExpr=u'$banner')) # from line 106, col 5.
        write(u'''</h1>
''')
...
#    Copyright (C) 2006-2015 StackFoundry LLC and Yann Ramin
''')
...
<div class="topbar">
  <ul>
    ...
    <li class="right">
''')
        _v = VFN(VFFSL(SL,"timehead",True),"Format",False)("%b %e %H:%M") # u'$timehead.Format("%b %e %H:%M")' on line 93, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$timehead.Format("%b %e %H:%M")')) # from line 93, col 1.
        write(u''' 
GMT
    </li>
...
<div id="bodyText">
''')
        _v = VFFSL(SL,"body",True) # u'$body' on line 110, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$body')) # from line 110, col 1.
        write(u'''
</div>
