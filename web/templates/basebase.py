...
__CHEETAH_genTime__ = 1265364453.600486
__CHEETAH_genTimestamp__ = 'Fri Feb  5 02:07:33 2010'
__CHEETAH_src__ = 'basebase.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Feb  5 02:07:05 2010'
...
<td class="alignRight">
''')
        if 'user' in VFFSL(SL,"session",True): # generated from line 92, col 1
            write(u'''<a href="/users/"><i>''')
            _v = VFN(VFFSL(SL,"session",True)['user'],"username",True) # u"$session['user'].username" on line 93, col 22
            if _v is not None: write(_filter(_v, rawExpr=u"$session['user'].username")) # from line 93, col 22.
...
''')
        ...
        write(u'''
''')
        _v = VFN(VFFSL(SL,"timehead",True),"Format",False)("%b %e %H:%M") # u'$timehead.Format("%b %e %H:%M")' on line 101, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$timehead.Format("%b %e %H:%M")')) # from line 101, col 1.
        write(u'''
</td>
</tr>
</table>
...
<!-- All times GMT unless otherwise specified. It is now: <b>''')
        _v = VFN(VFFSL(SL,"timefoot",True),"Format",False)("%b %e %H:%M") # u'$timefoot.Format("%b %e %H:%M")' on line 131, col 62
        if _v is not None: write(_filter(_v, rawExpr=u'$timefoot.Format("%b %e %H:%M")')) # from line 131, col 62.
        write(u''' (GMT)</b> -->
