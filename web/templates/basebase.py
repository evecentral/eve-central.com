...
__CHEETAH_genTime__ = 1416812465.73853
__CHEETAH_genTimestamp__ = 'Mon Nov 24 07:01:05 2014'
__CHEETAH_src__ = 'basebase.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Nov 24 07:00:41 2014'
...
''')
    ...
    def _banner(self, **KWS):
        ...
        ## CHEETAH: generated from #block _banner at line 111, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write(u'''<h1>''')
        _v = VFFSL(SL,"banner",True) # u'$banner' on line 112, col 5
        if _v is not None: write(_filter(_v, rawExpr=u'$banner')) # from line 112, col 5.
        write(u'''</h1>
''')
