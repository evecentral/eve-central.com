...
__CHEETAH_genTime__ = 1346136853.640148
__CHEETAH_genTimestamp__ = 'Tue Aug 28 06:54:13 2012'
__CHEETAH_src__ = 'basebase.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Aug 28 06:54:11 2012'
...
''')
    ...
    def _title(self, **KWS):
        ...
        ## CHEETAH: generated from #block _title at line 62, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write(u'''
''')
        if VFN(VFFSL(SL,"title",True),"find",False)("EVE-Central") != -1: # generated from line 64, col 1
            pass
        else: # generated from line 66, col 1
            write(u''' EVE-Central -
''')
        write(u''' ''')
        _v = VFFSL(SL,"title",True) # u'$title' on line 69, col 2
        if _v is not None: write(_filter(_v, rawExpr=u'$title')) # from line 69, col 2.
        write(u'''
''')
    ...
    def _banner(self, **KWS):
        ...
        ## CHEETAH: generated from #block _banner at line 102, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write(u'''<h1>''')
        _v = VFFSL(SL,"banner",True) # u'$banner' on line 103, col 5
        if _v is not None: write(_filter(_v, rawExpr=u'$banner')) # from line 103, col 5.
        write(u'''</h1>
''')
...
<script type="text/javascript" src="//use.typekit.net/yvc6jcj.js"></script>
...
<div class="topbar">
  <ul>
    ...
    <li class="right">
''')
        _v = VFN(VFFSL(SL,"timehead",True),"Format",False)("%b %e %H:%M") # u'$timehead.Format("%b %e %H:%M")' on line 90, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$timehead.Format("%b %e %H:%M")')) # from line 90, col 1.
        write(u''' 
GMT
    </li>
...
<div id="bodyText">
''')
        _v = VFFSL(SL,"body",True) # u'$body' on line 107, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$body')) # from line 107, col 1.
        write(u'''
</div>
