...
__CHEETAH_genTime__ = 1308704871.098326
__CHEETAH_genTimestamp__ = 'Wed Jun 22 01:07:51 2011'
__CHEETAH_src__ = 'basebase.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Jun 22 01:07:41 2011'
...
''')
    ...
    def _banner(self, **KWS):
        ...
        ## CHEETAH: generated from #block _banner at line 113, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write(u'''<h1>''')
        _v = VFFSL(SL,"banner",True) # u'$banner' on line 114, col 5
        if _v is not None: write(_filter(_v, rawExpr=u'$banner')) # from line 114, col 5.
        write(u'''</h1>
''')
...
<div class="standout">
<!--IMPORTANT: Protect the future of EVE-Central. Protest the <a href="http://www.eveonline.com/ingameboard.asp?a=topic&threadID=1528607">licensing proposal for EVE IP</a> brought forth by CCP hf. <i>Official statement to follow.</i> -->
IMPORTANT: Not updated for Incarna - your mileage may vary!
...
''')
        ...
        write(u'''
''')
        _v = VFN(VFFSL(SL,"timehead",True),"Format",False)("%b %e %H:%M") # u'$timehead.Format("%b %e %H:%M")' on line 104, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$timehead.Format("%b %e %H:%M")')) # from line 104, col 1.
        write(u'''
</td>
</tr>
</table>
...
''')
        ...
        write(u'''
''')
        if VFFSL(SL,"isigb",True): # generated from line 117, col 1
            write(u'''
''')
        else: # generated from line 119, col 1
            write(u'''    <div id="bodyText">
''')
        _v = VFFSL(SL,"body",True) # u'$body' on line 122, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$body')) # from line 122, col 1.
        write(u'''
...
<!-- All times GMT unless otherwise specified. It is now: <b>''')
        _v = VFN(VFFSL(SL,"timefoot",True),"Format",False)("%b %e %H:%M") # u'$timefoot.Format("%b %e %H:%M")' on line 134, col 62
        if _v is not None: write(_filter(_v, rawExpr=u'$timefoot.Format("%b %e %H:%M")')) # from line 134, col 62.
        write(u''' (GMT)</b> -->
